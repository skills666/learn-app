...
function body(bx,by,bw,bh){BODY_FNS[Math.min(chestSkin||0,5)](bx,by,bw,bh);}
function lid(lx,ly,lw,lh,rot){LID_FNS[Math.min(chestSkin||0,5)](lx,ly,lw,lh,rot);}
